...
resource "aws_subnet" "utility-k8s-us-east-2a-stellarbot-legacy-prod-us-east-2" {
  ...
  tags = {
    "KubernetesCluster"                                             = "stellarbot-legacy-prod-us-east-2.k8s.local"
    "Name"                                                          = "utility-us-east-2a.stellarbot-legacy-prod-us-east-2.k8s.local"
    "SubnetType"                                                    = "Utility"
    "kubernetes.io/cluster/stellarbot-legacy-prod-us-east-2.k8s.local" = "owned"
...
resource "aws_subnet" "utility-k8s-us-east-2b-stellarbot-legacy-prod-us-east-2" {
  ...
  tags = {
    "KubernetesCluster"                                             = "stellarbot-legacy-prod-us-east-2.k8s.local"
    "Name"                                                          = "utility-us-east-2b.stellarbot-legacy-prod-us-east-2.k8s.local"
    "SubnetType"                                                    = "Utility"
    "kubernetes.io/cluster/stellarbot-legacy-prod-us-east-2.k8s.local" = "owned"
    "kubernetes.io/role/elb"                                        = "1"
  }
