...
resource "aws_key_pair" "kubernetes-stellarbot-dev-us-east-2-k8s-local-bbc8fc03ce68a158fa3d8ebc67b0e2f5" {
  key_name   = "kubernetes.stellarbot-dev-us-east-2.k8s.local-bb:c8:fc:03:ce:68:a1:58:fa:3d:8e:bc:67:b0:e2:f5"
  public_key = file("${path.module}/data/aws_key_pair_kubernetes.stellarbot-dev-us-east-2.k8s.local-bbc8fc03ce68a158fa3d8ebc67b0e2f5_public_key")
  tags = {
    "KubernetesCluster"                                        = "stellarbot-dev-us-east-2.k8s.local"
    "Name"                                                     = "stellarbot-dev-us-east-2.k8s.local"
    "kubernetes.io/cluster/stellarbot-dev-us-east-2.k8s.local" = "owned"
...
resource "aws_launch_template" "master-us-east-2a-masters-stellarbot-dev-us-east-2-k8s-local" {
  ...
  key_name      = aws_key_pair.kubernetes-stellarbot-dev-us-east-2-k8s-local-bbc8fc03ce68a158fa3d8ebc67b0e2f5.id
  lifecycle {
