...
resource "aws_key_pair" "kubernetes-stellarbot-k8s-prod-us-east-2-k8s-local-ff2a0ea1c80a1cdf388d95966b1706d0" {
  key_name   = "kubernetes.stellarbot-k8s-prod-us-east-2.k8s.local-ff:2a:0e:a1:c8:0a:1c:df:38:8d:95:96:6b:17:06:d0"
  public_key = file("${path.module}/data/aws_key_pair_kubernetes.stellarbot-k8s-prod-us-east-2.k8s.local-ff2a0ea1c80a1cdf388d95966b1706d0_public_key")
  tags = {
    "KubernetesCluster"                                             = "stellarbot-k8s-prod-us-east-2.k8s.local"
    "Name"                                                          = "stellarbot-k8s-prod-us-east-2.k8s.local"
    "kubernetes.io/cluster/stellarbot-k8s-prod-us-east-2.k8s.local" = "owned"
...
resource "aws_launch_template" "master-us-east-2a-masters-stellarbot-k8s-prod-us-east-2-k8s-local" {
  ...
  key_name      = aws_key_pair.kubernetes-stellarbot-k8s-prod-us-east-2-k8s-local-ff2a0ea1c80a1cdf388d95966b1706d0.id
  lifecycle {
