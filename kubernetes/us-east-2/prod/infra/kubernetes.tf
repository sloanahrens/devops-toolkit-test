...
resource "aws_key_pair" "kubernetes-stellarbot-k8s-prod-us-east-2-k8s-local-30951e230dbf05102a503bdae082a785" {
  key_name   = "kubernetes.stellarbot-k8s-prod-us-east-2.k8s.local-30:95:1e:23:0d:bf:05:10:2a:50:3b:da:e0:82:a7:85"
  public_key = file("${path.module}/data/aws_key_pair_kubernetes.stellarbot-k8s-prod-us-east-2.k8s.local-30951e230dbf05102a503bdae082a785_public_key")
  tags = {
    "KubernetesCluster"                                             = "stellarbot-k8s-prod-us-east-2.k8s.local"
    "Name"                                                          = "stellarbot-k8s-prod-us-east-2.k8s.local"
    "kubernetes.io/cluster/stellarbot-k8s-prod-us-east-2.k8s.local" = "owned"
...
resource "aws_launch_template" "master-us-east-2a-masters-stellarbot-k8s-prod-us-east-2-k8s-local" {
  ...
  key_name      = aws_key_pair.kubernetes-stellarbot-k8s-prod-us-east-2-k8s-local-30951e230dbf05102a503bdae082a785.id
  lifecycle {
